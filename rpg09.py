...
while True:
    ...
    if 'item' in rooms[currentRoom] and 'monster' in rooms[currentRoom]['item']:
        if 'cookies' in inventory:
            ...
            del rooms[currentRoom]['item']
            print('A monster showed up and stole your cookies, then he ran away! You have lost your cookies!')
        else:
            print('A monster has you! Game Over')
            break

    if currentRoom == 'Garden' and 'skeletonkey' in inventory:
        print('You opened the old rusty gate in the garden and  escaped the hourse! YOU WIN!')
        break
